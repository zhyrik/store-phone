...
/**
 * functional react component. Main logic. Use in App.js
 * @function
 * @param {node} children
 * @returns {JSX.Element} - react component
 */
function MainLogickFunctions({ children }) {
...
MainLogickFunctions.propTypes = {
  children: PropTypes.node.isRequired
}

export default MainLogickFunctions
